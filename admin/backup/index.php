	...
	<div class="card-header">
        ...
        <div >
            ...
            <form  enctype="multipart/form-data" id="recoveryForm">
                ...
                <button type="button"  class=" btn btn-info  rounded-pill px-5" onclick="document.getElementById('backupFile').click()">
                <div class="align-items-center">
                    ...
                    <div >
                        ...
                        <script>
                            function submitForm() {
                                start_loader();
                                    fetch('backup/recover_async.php', {
                                        method: 'POST',
                                        ...
                                        .then(data => {
                                            if (data.conditionMet) {
                                                alert_toast("Back up execution is successfully done.");
                                                end_loader();
                                            }
                                           else{
                                            alert_toast("An error occurred1", 'error');
                                            end_loader();
                                        ...
                                        .catch(error => {
                                            ...
                                            alert_toast("An error occurred2", 'error');
                                            end_loader();
                                        })
                                        .finally(() => {
                                                makeXMLHttpRequest();
                                ...
                                fetch('backup/backup_async.php')
                                    ...
                                    .then(data => {
                                        if (data.conditionMet) {
                                            ...
                                            window.location.href = 'backup/backup_download.php?br_name=' + encodeURIComponent(data.br_name);
                                            end_loader();
                                        } else {
                                    ...
                                    function makeXMLHttpRequest() {
                                        ...
                                        xhr.open("GET", "backup/backup_fetch.php", true);
                                        xhr.send();
                                    }
