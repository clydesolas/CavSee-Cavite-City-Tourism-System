<section class="page-section mt-3">
    ...
    <div class="justify-content-between d-flex " >
        <div>
        <h4 class=""><b>Update Account Details</b></h4>
        ...
        <div class="col-md-9 ">
            ...
            <input type="hidden" name="id" value="<?php echo $_settings->userdata('id') ?>">
                ...
                <div class="form-group2">
                    ...
                    <input type="text" name="username" class="form-control form" value="<?php echo $_settings->userdata('username') ?>" readonly required>
                </div>
                <div class="form-group2">
                ...
                <div class="form-group d-flex justify-content-end">
                    <button class="btn btn-primary btn-flat" style="color: white; background-color: black; border-color: black">Update</button>
                </div>
            </form>
        </div>
    </div>
